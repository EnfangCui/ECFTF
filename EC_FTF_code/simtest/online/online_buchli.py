...
for file_raw_name in source_list:
    ...
    for i in range(range_start,range_end):
        ...
        (allocated1, f, l, u) = alg_buchli.allocate(pred_cycle_2)
    ...
    print("Final B0:",b0)
    result_filepath = divstring+"buchli_001"+file_raw_name+"_"+str(range_start)+"_"+str(range_end)+".txt"
